...
namespace temp0.Areas.Admin.Controllers
{
    public class SubscribersController : Controller
    {
        ...
        {
            var subscriber = db.Subscriber.Include(s => s.Users);
        ...
        public ActionResult Details(int? id)
        {
            ...
            Subscriber subscriber = db.Subscriber.Find(id);
            if (subscriber == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "id,users_id")] Subscriber subscriber)
        {
            ...
            ViewBag.users_id = new SelectList(db.Users, "id", "names", subscriber.users_id);
            return View(subscriber);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,users_id")] Subscriber subscriber)
        {
            if (ModelState.IsValid)
            {
